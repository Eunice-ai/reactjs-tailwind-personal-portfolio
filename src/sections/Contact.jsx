...
export const Contact = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setSubmitStatus({
        type: "success",
        message: "Message sent succesfuly! I'll get back to you soon.",
      });
  ...
  return (
    <section id="contact" className="py-32 relative overflow-hidden">
      <div className="absolute top-0 left-0 w-full h-full">
        ...
        <div className="absolute bottom-1/4 right-1/4 w-64 bg-hightlight/5 rounded-full blur-3xl" />
      </div>

      <div className="container mx-auto px-6 relative z-10">
        {/* Section Header */}
        <div className="text-center max-w-3xl mx-auto mb-16">
          <span className="text-secondary-foreground text-sm font-mediun tracking-wider uppercase animate-fade-in">
            Get in Touch
          </span>
